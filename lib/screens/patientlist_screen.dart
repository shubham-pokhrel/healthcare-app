    ...
    return Scaffold(
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          List<Patient> patients = isMobile
              ? mobilePatients
              : desktopPatients; // Fetch data based on screen type
                ...
                if (!isMobile) ...[
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: Color(
                                  0xFFD3DDE5), // Background color similar to the login screen
                              borderRadius: BorderRadius.circular(8),
                            ),
                            child: Center(
                              child: Text('test'),
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: SizedBox(
                        height: constraints.maxHeight * 0.65 > 557
                            ? 557
                            : constraints.maxHeight *
                                0.65, // Adjust height to your needs
                        width: constraints.maxWidth * 0.95 > 332
                            ? 332 + constraints.maxWidth * 0.3
